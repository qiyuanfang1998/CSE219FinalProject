...
public class AppGUI {
    ...
    protected FlowPane aboutMeToolbar;
    ...
    public FlowPane getAboutMeToolbar(){
        return aboutMeToolbar;
    }
	...
	// AND NOW SETUP THEIR EVENT HANDLERS
        ...
        newButton.setOnAction(e -> {
            ...
            fileController.handleNewRequest2();
            this.getWindow().setTitle("MetroMapMaker- "+fileController.getShizz());
        });
        ...
        topToolbarPane.getChildren().addAll(fileToolbar, undoRedoToolbar, aboutMeToolbar);
    }
   ...
   /**
	...
	topToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
        ...
        aboutMeToolbar.getStyleClass().add(CLASS_BORDERED_PANE);
